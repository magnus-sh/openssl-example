# Example C++ Application using OpenSSL [![Build Status](https://travis-ci.org/magnus-sh/openssl-example.svg?branch=master)](https://travis-ci.org/magnus-sh/openssl-example)
## Prerequisites
